...
NA stands for not applicable and I an getting this error as some of the data in the n_2021 column are NA and as all the data is not numerical it cannot calculate a mean or median
...
As the data is skewed to the right which has a big impact on the mean, making it larger, but it has a much smaller impact on the median.
...
The inter-quartile range for England and Scotland are quite reliable as they have a large data set however, the inter-quartile range for Northern Ireland and Wales is not reliable as their data set is very small.
